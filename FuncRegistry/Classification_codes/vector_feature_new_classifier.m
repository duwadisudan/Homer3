function [performanceLDALedoitHbO] = vector_feature_new_classifier(trials_HbOM_Tr,trials_HbOM_Tst,trials_HbRM_Tr,trials_HbRM_Tst,indexMoviesTrainMultiple,indexMoviesTestMultiple,timeLen,mlList,chOI,fs)
    ...
    deltaHbO_Tr = trials_HbOM_Tr(mlList,startT:endT,:);
    deltaHbR_Tr = trials_HbRM_Tr(mlList,startT:endT,:);

    deltaHbO_Tst = trials_HbOM_Tst(mlList,startT:endT,:);
    deltaHbR_Tst = trials_HbRM_Tst(mlList,startT:endT,:);
    ...
    for i2 = 1:length(timeLen)
      ...
      [performanceLDALedoitHbO(1,i2)] = neural_net(featureVector_Tr, expandedLabels_Tr, ...
